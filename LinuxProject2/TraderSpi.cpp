...
#endif
CTraderSpi::CTraderSpi(CMyTraderApi *pTrader):m_pUserApi(pTrader)
{
...
void CTraderSpi::OnRspUserLogin(CDINGFtdcRspUserLoginField *pRspUserLogin, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
void CTraderSpi::OnRspOrderInsert(CDINGFtdcInputOrderField *pInputOrder, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("-----------------------------\n");
...
void CTraderSpi::OnRtnTrade(CDINGFtdcTradeField *pTrade)
{
	printf("-----------------------------\n");
	printf("收到成交回报\n");
	Show(pTrade);
...
void CTraderSpi::Show(CDINGFtdcOrderField *pOrder)
{
	printf("-----------------------------\n");
	printf("交易所代码=[%s]\n",pOrder->ExchangeID);
	printf("交易日=[%s]\n",pOrder->TradingDay);
...
void CTraderSpi::OnRtnOrder(CDINGFtdcOrderField *pOrder)
{
	printf("-----------------------------\n");
	printf("收到报单回报\n");
	Show(pOrder);
...
void CTraderSpi::OnRspOrderAction(CDINGFtdcOrderActionField *pOrderAction, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("-----------------------------\n");
...
void CTraderSpi::OnRspUserPasswordUpdate(CDINGFtdcUserPasswordUpdateField *pUserPasswordUpdate, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("-----------------------------\n");
...
void CTraderSpi::OnErrRtnOrderInsert(CDINGFtdcInputOrderField *pInputOrder, CDINGFtdcRspInfoField *pRspInfo)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("-----------------------------\n");
...
void CTraderSpi::OnErrRtnOrderAction(CDINGFtdcOrderActionField *pOrderAction, CDINGFtdcRspInfoField *pRspInfo)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("-----------------------------\n");
...
void CTraderSpi::OnRspQryOrder(CDINGFtdcOrderField *pOrder, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("-----------------------------\n");
...
void CTraderSpi::Show(CDINGFtdcTradeField *pTrade)
{
	printf("-----------------------------\n");
	printf("交易所代码=[%s]\n",pTrade->ExchangeID);
	printf("交易日=[%s]\n",pTrade->TradingDay);
...
void CTraderSpi::OnRspQryTrade(CDINGFtdcTradeField *pTrade, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("-----------------------------\n");
...
void CTraderSpi::OnRspQryExchange(CDINGFtdcRspExchangeField *pRspExchange, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("-----------------------------\n");
...
void CTraderSpi::OnRspQryInvestorAccount(CDINGFtdcRspInvestorAccountField *pRspInvestorAccount, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("-----------------------------\n");
...
void CTraderSpi::OnRspQryUserInvestor(CDINGFtdcRspUserInvestorField *pUserInvestor, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("-----------------------------\n");
...
void CTraderSpi::Show(CDINGFtdcRspInstrumentField *pRspInstrument)
{
	printf("-----------------------------\n");
...
void CTraderSpi::OnRspQryInstrument(CDINGFtdcRspInstrumentField *pRspInstrument, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
...
void CTraderSpi::OnRspQryTradingCode(CDINGFtdcRspTradingCodeField *pTradingCode, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
		printf("查询交易编码失败 错误原因：%s\n", UTF8(pRspInfo->ErrorMsg));
...
void CTraderSpi::OnRspQryInvestorPosition(CDINGFtdcRspInvestorPositionField *pRspInvestorPosition, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
	...
	///投资者手续费率查询应答
void CTraderSpi::OnRspQryInvestorFee(CDINGFtdcInvestorFeeField *pInvestorFee, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
	...
	///投资者保证金率查询应答
void CTraderSpi::OnRspQryInvestorMargin(CDINGFtdcInvestorMarginField *pInvestorMargin, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
...
void CTraderSpi::OnRspQryComplianceParam(CDINGFtdcRspComplianceParamField *pRspComplianceParam, CDINGFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) 
{
	if (pRspInfo!=NULL&&pRspInfo->ErrorID!=0)
	{
...
int icount=0;
void CTraderSpi::OnRtnInstrumentStatus(CDINGFtdcInstrumentStatusField *pInstrumentStatus)
{
...
void CTraderSpi::OnRtnInvestorAccountDeposit(CDINGFtdcInvestorAccountDepositResField *pInvestorAccountDepositRes)
{
